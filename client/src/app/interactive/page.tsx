        ...
        <>
            <div className="" style={{display: "flex", flexDirection: "row"}}>
                ...
                >
                    ...
                    <Button as={Link} href="/interactive" variant='shadow' color='danger' style={{
                        borderRadius: '30px',
                        height: '7vh',
                        fontSize: '20px',
                        margin: 15,
                ...
                <div className=""
                    ...
                    <div className="input"
                         style={{paddingLeft: '50px', paddingRight: '50px', marginTop: '20px', marginBottom: '20px',width:'50%',display:'flex',flexDirection:'row'}}>
                        <Autocomplete
